...
The code for the this project is handled via its [GitHub Repository](https://github.com/themehybrid/hybrid-theme).  You can open tickets, create patches, and send pull requests there.
...
This project uses [semantic versioning](https://semver.org).  Version numbers will look like `3.2.1` where `3` is the "major" release, `2` is the minor release, and `1` is the patch release.
